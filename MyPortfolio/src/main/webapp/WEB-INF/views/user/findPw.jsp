	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4 w3-auto" style="width: 382px;height: 456.3px;">
			...
			<div>
				...
				<p>
					<label>휴대폰 번호</label>
					<input class="w3-input" type="text" id="phoneNumber" name="phoneNumber" placeholder="회원가입한 휴대폰 번호를 입력하세요" required>
				</p>
				<p class="w3-center">
					<button type="button" id="findBtn" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">찾기</button>
					<button type="button" onclick="window.close();" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">종료하기</button>
				</p>
			</div>
		</div>
	</div>
